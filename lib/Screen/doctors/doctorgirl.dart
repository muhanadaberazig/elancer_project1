...
class DoctorsGirlScreen extends StatefulWidget {
  const DoctorsGirlScreen({Key? key}) : super(key: key);

  @override
  _DoctorsGirlScreenState createState() => _DoctorsGirlScreenState();
}

class _DoctorsGirlScreenState extends State<DoctorsGirlScreen> {
  @override
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Container(
                                    height:30,
                                    child: Text('Palestine_Gaza_Rafah',style: TextStyle(fontSize: 18,fontWeight: FontWeight.w700,color: HexColor('#36596A')),)),
                              ],
                            ),
                            const Divider(
                              thickness: 2.5,
                            ...
                            Row(
                              children: [
                                ...
                                Container(
                                    height:30,
                                    child: Text('+9725959586',style: TextStyle(fontSize: 18,fontWeight: FontWeight.w700,color: HexColor('#36596A')),)),
                              ],
                            ),
                            const Divider(
                              thickness: 2.5,
                            ...
                            Row(
                              children: [
                                ...
                                Container(
                                    height:30,
                                    child: Text('Gaza _ Al Awda Street',style: TextStyle(fontSize: 18,fontWeight: FontWeight.w700,color: HexColor('#36596A')),)),
                              ],
                            ),
